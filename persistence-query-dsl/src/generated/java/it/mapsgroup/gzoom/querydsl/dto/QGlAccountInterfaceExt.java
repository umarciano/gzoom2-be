...
/**
 * QGlAccountInterfaceExt is a Querydsl query type for GlAccountInterfaceExt
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QGlAccountInterfaceExt extends com.querydsl.sql.RelationalPathBase<GlAccountInterfaceExt> {

    private static final long serialVersionUID = 1262615653;

    public static final QGlAccountInterfaceExt glAccountInterfaceExt = new QGlAccountInterfaceExt("GL_ACCOUNT_INTERFACE_EXT");
    ...
    public final com.querydsl.sql.PrimaryKey<GlAccountInterfaceExt> primary = createPrimaryKey(id);

    public QGlAccountInterfaceExt(String variable) {
        super(GlAccountInterfaceExt.class, forVariable(variable), "null", "GL_ACCOUNT_INTERFACE_EXT");
        addMetadata();
    }

    public QGlAccountInterfaceExt(String variable, String schema, String table) {
        super(GlAccountInterfaceExt.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QGlAccountInterfaceExt(String variable, String schema) {
        super(GlAccountInterfaceExt.class, forVariable(variable), schema, "GL_ACCOUNT_INTERFACE_EXT");
        addMetadata();
    }

    public QGlAccountInterfaceExt(Path<? extends GlAccountInterfaceExt> path) {
        super(path.getType(), path.getMetadata(), "null", "GL_ACCOUNT_INTERFACE_EXT");
        addMetadata();
    }

    public QGlAccountInterfaceExt(PathMetadata metadata) {
        super(GlAccountInterfaceExt.class, metadata, "null", "GL_ACCOUNT_INTERFACE_EXT");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(accountNameLang, ColumnMetadata.named("ACCOUNT_NAME_LANG").withIndex(29).ofType(Types.VARCHAR).withSize(2000));
        ...
        addMetadata(calcCustomMethodId, ColumnMetadata.named("CALC_CUSTOM_METHOD_ID").withIndex(26).ofType(Types.VARCHAR).withSize(20));
        addMetadata(customDate01, ColumnMetadata.named("CUSTOM_DATE01").withIndex(39).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate02, ColumnMetadata.named("CUSTOM_DATE02").withIndex(40).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate03, ColumnMetadata.named("CUSTOM_DATE03").withIndex(41).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate04, ColumnMetadata.named("CUSTOM_DATE04").withIndex(42).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate05, ColumnMetadata.named("CUSTOM_DATE05").withIndex(43).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customText01, ColumnMetadata.named("CUSTOM_TEXT01").withIndex(34).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customText02, ColumnMetadata.named("CUSTOM_TEXT02").withIndex(35).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customText03, ColumnMetadata.named("CUSTOM_TEXT03").withIndex(36).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customText04, ColumnMetadata.named("CUSTOM_TEXT04").withIndex(37).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customText05, ColumnMetadata.named("CUSTOM_TEXT05").withIndex(38).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customValue01, ColumnMetadata.named("CUSTOM_VALUE01").withIndex(44).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        addMetadata(customValue02, ColumnMetadata.named("CUSTOM_VALUE02").withIndex(45).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        addMetadata(customValue03, ColumnMetadata.named("CUSTOM_VALUE03").withIndex(46).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        addMetadata(customValue04, ColumnMetadata.named("CUSTOM_VALUE04").withIndex(47).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        addMetadata(customValue05, ColumnMetadata.named("CUSTOM_VALUE05").withIndex(48).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        ...
        addMetadata(description, ColumnMetadata.named("DESCRIPTION").withIndex(8).ofType(Types.VARCHAR).withSize(2000));
        addMetadata(descriptionLang, ColumnMetadata.named("DESCRIPTION_LANG").withIndex(30).ofType(Types.VARCHAR).withSize(2000));
        addMetadata(detectOrgUnitIdFlag, ColumnMetadata.named("DETECT_ORG_UNIT_ID_FLAG").withIndex(28).ofType(Types.CHAR).withSize(1));
        ...
        addMetadata(inputEnumId, ColumnMetadata.named("INPUT_ENUM_ID").withIndex(25).ofType(Types.VARCHAR).withSize(20));
        ...
        addMetadata(prioCalc, ColumnMetadata.named("PRIO_CALC").withIndex(27).ofType(Types.DECIMAL).withSize(20));
        ...
        addMetadata(seq, ColumnMetadata.named("SEQ").withIndex(49).ofType(Types.DECIMAL).withSize(20));
        addMetadata(source, ColumnMetadata.named("SOURCE").withIndex(23).ofType(Types.VARCHAR).withSize(2000));
        addMetadata(sourceLang, ColumnMetadata.named("SOURCE_LANG").withIndex(31).ofType(Types.VARCHAR).withSize(2000));
