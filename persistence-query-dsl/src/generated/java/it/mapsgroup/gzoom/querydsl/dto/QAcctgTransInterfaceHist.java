...
/**
 * QAcctgTransInterfaceHist is a Querydsl query type for AcctgTransInterfaceHist
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QAcctgTransInterfaceHist extends com.querydsl.sql.RelationalPathBase<AcctgTransInterfaceHist> {

    private static final long serialVersionUID = 1521117020;

    public static final QAcctgTransInterfaceHist acctgTransInterfaceHist = new QAcctgTransInterfaceHist("ACCTG_TRANS_INTERFACE_HIST");
    ...
    public final com.querydsl.sql.PrimaryKey<AcctgTransInterfaceHist> primary = createPrimaryKey(id);

    public QAcctgTransInterfaceHist(String variable) {
        super(AcctgTransInterfaceHist.class, forVariable(variable), "null", "ACCTG_TRANS_INTERFACE_HIST");
        addMetadata();
    }

    public QAcctgTransInterfaceHist(String variable, String schema, String table) {
        super(AcctgTransInterfaceHist.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QAcctgTransInterfaceHist(String variable, String schema) {
        super(AcctgTransInterfaceHist.class, forVariable(variable), schema, "ACCTG_TRANS_INTERFACE_HIST");
        addMetadata();
    }

    public QAcctgTransInterfaceHist(Path<? extends AcctgTransInterfaceHist> path) {
        super(path.getType(), path.getMetadata(), "null", "ACCTG_TRANS_INTERFACE_HIST");
        addMetadata();
    }

    public QAcctgTransInterfaceHist(PathMetadata metadata) {
        super(AcctgTransInterfaceHist.class, metadata, "null", "ACCTG_TRANS_INTERFACE_HIST");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(createdStamp, ColumnMetadata.named("CREATED_STAMP").withIndex(27).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(createdTxStamp, ColumnMetadata.named("CREATED_TX_STAMP").withIndex(28).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate01, ColumnMetadata.named("CUSTOM_DATE01").withIndex(34).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate02, ColumnMetadata.named("CUSTOM_DATE02").withIndex(35).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate03, ColumnMetadata.named("CUSTOM_DATE03").withIndex(36).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate04, ColumnMetadata.named("CUSTOM_DATE04").withIndex(37).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customDate05, ColumnMetadata.named("CUSTOM_DATE05").withIndex(38).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(customText01, ColumnMetadata.named("CUSTOM_TEXT01").withIndex(29).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customText02, ColumnMetadata.named("CUSTOM_TEXT02").withIndex(30).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customText03, ColumnMetadata.named("CUSTOM_TEXT03").withIndex(31).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customText04, ColumnMetadata.named("CUSTOM_TEXT04").withIndex(32).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customText05, ColumnMetadata.named("CUSTOM_TEXT05").withIndex(33).ofType(Types.VARCHAR).withSize(255));
        addMetadata(customValue01, ColumnMetadata.named("CUSTOM_VALUE01").withIndex(39).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        addMetadata(customValue02, ColumnMetadata.named("CUSTOM_VALUE02").withIndex(40).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        addMetadata(customValue03, ColumnMetadata.named("CUSTOM_VALUE03").withIndex(41).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        addMetadata(customValue04, ColumnMetadata.named("CUSTOM_VALUE04").withIndex(42).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        addMetadata(customValue05, ColumnMetadata.named("CUSTOM_VALUE05").withIndex(43).ofType(Types.DECIMAL).withSize(18).withDigits(6));
        ...
        addMetadata(histJobLogId, ColumnMetadata.named("HIST_JOB_LOG_ID").withIndex(24).ofType(Types.VARCHAR).withSize(20));
        addMetadata(id, ColumnMetadata.named("ID").withIndex(1).ofType(Types.VARCHAR).withSize(20).notNull());
        addMetadata(lastUpdatedStamp, ColumnMetadata.named("LAST_UPDATED_STAMP").withIndex(25).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(lastUpdatedTxStamp, ColumnMetadata.named("LAST_UPDATED_TX_STAMP").withIndex(26).ofType(Types.TIMESTAMP).withSize(26));
        ...
        addMetadata(seq, ColumnMetadata.named("SEQ").withIndex(44).ofType(Types.DECIMAL).withSize(20));
        ...
        addMetadata(uomDescr, ColumnMetadata.named("UOM_DESCR").withIndex(5).ofType(Types.VARCHAR).withSize(255));
        ...
        addMetadata(voucherRef, ColumnMetadata.named("VOUCHER_REF").withIndex(4).ofType(Types.VARCHAR).withSize(60));
