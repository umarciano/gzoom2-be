...
public class QUomRangeValues extends com.querydsl.sql.RelationalPathBase<UomRangeValues> {
    ...
    public void addMetadata() {
        ...
        addMetadata(createdStamp, ColumnMetadata.named("CREATED_STAMP").withIndex(16).ofType(Types.TIMESTAMP).withSize(19));
        addMetadata(createdTxStamp, ColumnMetadata.named("CREATED_TX_STAMP").withIndex(17).ofType(Types.TIMESTAMP).withSize(19));
        ...
        addMetadata(lastUpdatedStamp, ColumnMetadata.named("LAST_UPDATED_STAMP").withIndex(14).ofType(Types.TIMESTAMP).withSize(19));
        addMetadata(lastUpdatedTxStamp, ColumnMetadata.named("LAST_UPDATED_TX_STAMP").withIndex(15).ofType(Types.TIMESTAMP).withSize(19));
