...
/**
 * QGlAccountInterface is a Querydsl query type for GlAccountInterface
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QGlAccountInterface extends com.querydsl.sql.RelationalPathBase<GlAccountInterface> {

    private static final long serialVersionUID = -1397108708;

    public static final QGlAccountInterface glAccountInterface = new QGlAccountInterface("GL_ACCOUNT_INTERFACE");
    ...
    public final com.querydsl.sql.PrimaryKey<GlAccountInterface> primary = createPrimaryKey(id);

    public QGlAccountInterface(String variable) {
        super(GlAccountInterface.class, forVariable(variable), "null", "GL_ACCOUNT_INTERFACE");
        addMetadata();
    }

    public QGlAccountInterface(String variable, String schema, String table) {
        super(GlAccountInterface.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QGlAccountInterface(String variable, String schema) {
        super(GlAccountInterface.class, forVariable(variable), schema, "GL_ACCOUNT_INTERFACE");
        addMetadata();
    }

    public QGlAccountInterface(Path<? extends GlAccountInterface> path) {
        super(path.getType(), path.getMetadata(), "null", "GL_ACCOUNT_INTERFACE");
        addMetadata();
    }

    public QGlAccountInterface(PathMetadata metadata) {
        super(GlAccountInterface.class, metadata, "null", "GL_ACCOUNT_INTERFACE");
        addMetadata();
    }
    ...
    public void addMetadata() {
        ...
        addMetadata(descriptionLang, ColumnMetadata.named("DESCRIPTION_LANG").withIndex(30).ofType(Types.VARCHAR).withSize(255));
        ...
        addMetadata(sourceLang, ColumnMetadata.named("SOURCE_LANG").withIndex(31).ofType(Types.VARCHAR).withSize(255));
