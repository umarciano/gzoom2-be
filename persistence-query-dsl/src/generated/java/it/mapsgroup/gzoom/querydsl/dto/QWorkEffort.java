...
public class QWorkEffort extends com.querydsl.sql.RelationalPathBase<WorkEffort> {
    ...
    public final com.querydsl.sql.ForeignKey<WorkEffortAnalysis> _weaWeFk = createInvForeignKey(workEffortId, "WORK_EFFORT_ID");
    ...
    public void addMetadata() {
        ...
        addMetadata(actualCompletionDate, ColumnMetadata.named("ACTUAL_COMPLETION_DATE").withIndex(18).ofType(Types.TIMESTAMP).withSize(26));
        ...
        addMetadata(actualStartDate, ColumnMetadata.named("ACTUAL_START_DATE").withIndex(17).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(createdByUserLogin, ColumnMetadata.named("CREATED_BY_USER_LOGIN").withIndex(49).ofType(Types.VARCHAR).withSize(250));
        addMetadata(createdDate, ColumnMetadata.named("CREATED_DATE").withIndex(48).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(createdStamp, ColumnMetadata.named("CREATED_STAMP").withIndex(54).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(createdTxStamp, ColumnMetadata.named("CREATED_TX_STAMP").withIndex(55).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(currentStatusId, ColumnMetadata.named("CURRENT_STATUS_ID").withIndex(3).ofType(Types.VARCHAR).withSize(20));
        addMetadata(dataSoll, ColumnMetadata.named("DATA_SOLL").withIndex(87).ofType(Types.TIMESTAMP).withSize(26));
        ...
        addMetadata(estimatedCompletionDate, ColumnMetadata.named("ESTIMATED_COMPLETION_DATE").withIndex(16).ofType(Types.TIMESTAMP).withSize(26));
        ...
        addMetadata(estimatedStartDate, ColumnMetadata.named("ESTIMATED_START_DATE").withIndex(15).ofType(Types.TIMESTAMP).withSize(26));
        ...
        addMetadata(lastCorrectScoreDate, ColumnMetadata.named("LAST_CORRECT_SCORE_DATE").withIndex(70).ofType(Types.TIMESTAMP).withSize(26));
        ...
        addMetadata(lastModifiedDate, ColumnMetadata.named("LAST_MODIFIED_DATE").withIndex(50).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(lastStatusUpdate, ColumnMetadata.named("LAST_STATUS_UPDATE").withIndex(4).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(lastUpdatedStamp, ColumnMetadata.named("LAST_UPDATED_STAMP").withIndex(52).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(lastUpdatedTxStamp, ColumnMetadata.named("LAST_UPDATED_TX_STAMP").withIndex(53).ofType(Types.TIMESTAMP).withSize(26));
        ...
        addMetadata(scheduledCompletionDate, ColumnMetadata.named("SCHEDULED_COMPLETION_DATE").withIndex(84).ofType(Types.TIMESTAMP).withSize(26));
        addMetadata(scheduledStartDate, ColumnMetadata.named("SCHEDULED_START_DATE").withIndex(83).ofType(Types.TIMESTAMP).withSize(26));
        ...
        addMetadata(snapShotDate, ColumnMetadata.named("SNAP_SHOT_DATE").withIndex(78).ofType(Types.TIMESTAMP).withSize(26));
