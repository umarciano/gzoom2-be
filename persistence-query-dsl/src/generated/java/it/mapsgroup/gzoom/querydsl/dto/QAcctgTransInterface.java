...
/**
 * QAcctgTransInterface is a Querydsl query type for AcctgTransInterface
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QAcctgTransInterface extends com.querydsl.sql.RelationalPathBase<AcctgTransInterface> {

    private static final long serialVersionUID = 60436762;

    public static final QAcctgTransInterface acctgTransInterface = new QAcctgTransInterface("ACCTG_TRANS_INTERFACE");
    ...
    public final com.querydsl.sql.PrimaryKey<AcctgTransInterface> primary = createPrimaryKey(id);

    public QAcctgTransInterface(String variable) {
        super(AcctgTransInterface.class, forVariable(variable), "null", "ACCTG_TRANS_INTERFACE");
        addMetadata();
    }

    public QAcctgTransInterface(String variable, String schema, String table) {
        super(AcctgTransInterface.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QAcctgTransInterface(String variable, String schema) {
        super(AcctgTransInterface.class, forVariable(variable), schema, "ACCTG_TRANS_INTERFACE");
        addMetadata();
    }

    public QAcctgTransInterface(Path<? extends AcctgTransInterface> path) {
        super(path.getType(), path.getMetadata(), "null", "ACCTG_TRANS_INTERFACE");
        addMetadata();
    }

    public QAcctgTransInterface(PathMetadata metadata) {
        super(AcctgTransInterface.class, metadata, "null", "ACCTG_TRANS_INTERFACE");
        addMetadata();
    }
