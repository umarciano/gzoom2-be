...
public abstract class Report {
    ...
    protected JasperServiceProgress jasperServiceProgress;
    ...
    public Report(String taskId, String name, String type, Map<String, Object> parameters, Locale reportLocale) {
        ...
        this.taskId = taskId;
        this.jasperServiceProgress = new JasperServiceProgress();
    }
    ...
    public JasperServiceProgress getJasperServiceProgress() {
        return jasperServiceProgress;
    }
