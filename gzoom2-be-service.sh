...
# Non affidarsi a GZOOM_ENV da ~/.bashrc perche' 'sudo service' non eredita l'environment utente.
...
start_service() {
  ...
  log_success_msg "Starting gzoom2-be-service with GZOOM_ENV=${GZOOM_ENV_VALUE:-<not set>}"
