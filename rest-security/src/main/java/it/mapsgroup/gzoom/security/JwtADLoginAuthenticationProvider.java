...
import static org.springframework.security.ldap.LdapUtils.closeContext;
...
public class JwtADLoginAuthenticationProvider implements AuthenticationProvider, PluggableAuthenticationProvider {
    private static final org.slf4j.Logger LOG = getLogger(JwtADLoginAuthenticationProvider.class);
