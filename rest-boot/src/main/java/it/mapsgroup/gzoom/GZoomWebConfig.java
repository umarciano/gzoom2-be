...
public class GZoomWebConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(HttpMethod.POST, "/logout", "/login","/api/getToken","/api/doLogout","/api/sso-login","/api/ott-login").permitAll();
        ...
        http.authorizeRequests().antMatchers(HttpMethod.OPTIONS, "/api/getToken", "/api/sso-login", "/api/ott-login").permitAll();
        ...
        RequestMatcher ssoLogin = new AntPathRequestMatcher("/api/sso-login");
        RequestMatcher ottLogin = new AntPathRequestMatcher("/api/ott-login");
        ...
        RequestMatcher ignoredRequests = new OrRequestMatcher(profile, logout, login, ssoLogin, ottLogin, reminderPeriod, reminderExipry, userPreferenceNA, configuration, version, logo, partiesExposed);
